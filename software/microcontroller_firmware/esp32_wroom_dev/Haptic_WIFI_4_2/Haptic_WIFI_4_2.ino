...
bool UseWIFIinsteadOfUSB = false;
...
delay(2000); // Allow some time for serial port to initialize
...
void ReadDataFromSerialPort() {
    ...
    char inChar = Serial.read();
      ...
      } else if (inStringIndex == 15) {
      SetMicrocontrollerSetting(inString);}
      inStringIndex = 0;
    } else if (isdigit(inChar) && inStringIndex < (MAX_INPUT_LENGTH - 1)) {
